...
export default function AdminSettingsPage() {
  return (
    <div className="space-y-6">
      <PageTitle title="Settings" description="Configure categories, routing, and notification behavior." />
        ...
        <Card title="Agency Routing Rules">
          <div className="space-y-3 text-sm text-slate-700">
            <div className="rounded-lg border border-slate-200 p-3">
              ...
              <p className="mt-1 text-xs text-slate-500">Route to Flood Response Team and Water Safety Unit.</p>
            </div>
            <div className="rounded-lg border border-slate-200 p-3">
              <p className="font-medium text-slate-900">Fire category</p>
              <p className="mt-1 text-xs text-slate-500">Route to Urban Fire Service and medical backup.</p>
            </div>
          </div>
        </Card>
