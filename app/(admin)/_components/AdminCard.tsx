...
const statusStyles: Record<'success' | 'warning' | 'danger' | 'neutral', string> = {
...
export function StatusBadge({
  ...
  return (
    <span className={cn('inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium', statusStyles[tone])}>
      {label}
    </span>
  )
}
